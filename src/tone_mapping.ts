...
// Tone Mapping      indends to convert HDR(high dinamic range)
// values into LDR (low dynamic range)
// But Tone Mapping in Three.js will actually fake the process of converting LDR to HDR
// even if the colors aren't HDR resulting in a very realistic render

// Update toneMapping on the WebGLRenderer (we are going to test all of those with gui and)
// we are setting these for `renderer.toneMapping`
//    THREE.NoToneMapping (default)
//    THREE.LinearToneMapping
//    THREE.ReinhardToneMapping  // Colors look washed out but very realistic like with a poorly set camera (we are going to use this one when following the lesson)
//    THREE.CineonToneMapping
//    THREE.ACESFilmicToneMapping  // favorite for the author of workshop

// we will also set
// toneMappingExpossure = 3   // this is about how much ligh you let in (how strong toneMapping is)
