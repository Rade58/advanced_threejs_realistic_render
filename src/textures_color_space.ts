...
// first we need to add floor and wall textures, you downloaded from Ply Heaven
// use 1k, it's enough for this project; you can use what ever you want but 1k is enough
// in terms of file format, pick:
// - jpg for ao/roughness/metallnes texture
// - jpg for difuse (most important, because this is color)
// - png for normal(gl)
//

// since we are loading bunch of textures we are going to use THREE.TextureLoader
// we than created 8 x 8 plane right bellow the model
// and 8x8 plane behind the model

// Even you sett all, color of texture will look bad, it will look washed out
//

// The textures looks oddly white and this is due to the "color space"
// Color space is a way to optimise how colors are being stored according to the human
// eye sensitivity
// Mostly concerns textures that are supposed to be seen (in our case wallColorTexture)
// we can fix this by changing colorSpace, but only for color textures to
// be `THREE.SRGBColorSpace`
